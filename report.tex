...
\begin{table}[ht]
	\label{tab: redDat}
		...
		\begin{tabular}{c}
    		 \fbox{
			\parbox{\linewidth}{
				\lstinputlisting[label = samplecode, firstline=33,lastline=50]{movie.py}
			}
		}
		\end{tabular}
		\caption{(UR $\times$ IDF)}
